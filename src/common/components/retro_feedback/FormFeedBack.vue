  ...
  <div class="fixed inset-0 flex items-center justify-center z-50">
    ...
    <div class="bg-gray-100 p-6 rounded-lg shadow-md z-10 w-full max-w-sm">
      <div class="flex justify-between items-center mb-4">
        <h2 class="text-xl font-semibold text-gray-800">Add New Feedback</h2>
        <button @click="$emit('closeModal')" class="text-gray-600 hover:text-gray-800 focus:outline-none">
      ...
      <form @submit.prevent="handleSubmit">
        <div class="mb-4">
          ...
          <textarea id="content" v-model="feedbackContent"
